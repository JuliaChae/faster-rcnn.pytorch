...
if __name__ == '__main__':
  ...
  input_dir = "/home/julia/faster-rcnn.pytorch/data/trained_model/res101/nuscenes"
  ...
  nuscenes_classes = np.asarray(['__background__',  # always index 0
                         ...
                         'vehicle.bicycle', 'vehicle.bus.bendy', 'vehicle.bus.rigid', 'vehicle.car', 'vehicle.construction', 'vehicle.emergency.ambulance', 
                         'vehicle.emergency.police', 'vehicle.motorcycle', 'vehicle.trailer', 'vehicle.truck', 'static_object.bicycle_rack']) 
  """
  nuscenes_classes = np.asarray(['__background__',  # always index 0
      ...
      for j in xrange(1, len(nuscenes_classes)):
          ...
          if inds.numel() > 0:
            ...
            for i in range(np.minimum(10, cls_dets.cpu().numpy().shape[0])):
                ...
                print("Found a bounding box " + str(bbox))
                bot_left = bbox[0:2]
                top_right = bbox[2:4] 
