...
class nuscenes(imdb):
    def __init__(self, image_set):
        imdb.__init__(self, 'nuscenes_' + image_set)
        self._image_set = image_set
        self._data_path = '/data/sets/nuscenes/'
        ...
        self._image_ext = '.jpg'
        self._image_index = self._load_image_set_index() #get the image names in train, test set 
    ...
    def image_path_at(self, i):
        ...
        """
        return "/data/sets/nuscenes/" + self._image_index[i]
    ...
    def _load_image_set_index(self):
        ...
        image_set_file = os.path.join('/data/sets/nuscenes/',
                                      self._image_set + '.txt')
